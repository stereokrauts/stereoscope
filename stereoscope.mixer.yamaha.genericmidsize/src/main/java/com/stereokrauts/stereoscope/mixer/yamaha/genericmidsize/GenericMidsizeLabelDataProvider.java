 ...
 *
 */
public class GenericMidsizeLabelDataProvider {
	...
	public GenericMidsizeLabelDataProvider(final SampleRate samplerate) {

		this.sampleRate = samplerate;
		/* JUST FOR TESTING
		 * sm doesn't have a samplerate
		 */
		if (this.sampleRate == SampleRate.R_UNDEFINED) {
			this.sampleRate = SampleRate.R_44100;
			logger.info("Didn't receive the samplerate from mixer yet, assuming 44.1 kHz.");
		}
		...
		if (this.sampleRate == SampleRate.R_44100) {
			this.setYamahaDynamicDecayRelease44kHzGenericMidsizePm5d();
			this.setYamahaDynamicHold44kHz();
		} else if (this.sampleRate == SampleRate.R_48000) {
			this.setYamahaDynamicDecayRelease48kHzGenericMidsizePm5d();
			this.setYamahaDynamicHold48kHzGenericMidsizePm5d();
		} else if (this.sampleRate == SampleRate.R_88200) {
			this.setYamahaDynamicDecayRelease88kHzGenericMidsize();
			this.setYamahaDynamicHold88kHzGenericMidsize();
		} else if (this.sampleRate == SampleRate.R_96000) {
			this.setYamahaDynamicDecayRelease96kHzGenericMidsize();
			this.setYamahaDynamicHold96kHzGenericMidsize();
		}
	...
	public GenericMidsizeLabelDataProvider() {
		this(SampleRate.R_UNDEFINED);
	}
	...
	private void setLabelDecayReleaseTable(final String[] labelDecayReleaseTable) {
		this.labelDecayReleaseTable = labelDecayReleaseTable;
	}

	public void setLableRangeTable() {
	...
	public void setLabelThresholdTable() {
		this.labelThresholdTable = new String[541];
		for (int i = 0; i < this.labelThresholdTable.length; i++) {
			final DecimalFormat df = new DecimalFormat("0.0");
			final String value = df.format((float) (i) / (float) (10) - (54));
	...
	public String getYamahaLabelLevel10Db(final float value) {
		return this.labelLevelTable[((int) (value * 1023))];
	}

	public String getYamahaLabelPeqQ(final int value) {
		return this.labelPeqQTable[value];
	}

	public String getYamahaLabelPeqF(final int value) {
		return this.labelPeqFTable[value];
	}

	public String getYamahaLabelFilterType(final int value) {
		return this.labelPeqFilterTypeTable[value];
	}

	public String getYamahaLabelDynaRange(final float value) {
		return this.labelRangeTable[(int) (value * 70)];
	}

	public String getYamahaLabelDynaRatio(final float value) {
		return this.labelRatioTable[(int) (value * 15)];
	}

	public String getYamahaLabelDynaType(final int proc, final float value) {
		String label = "";
	...
	public String getYamahaLabelDynaHold(final float value) {
		return this.labelHoldTable[(int) (value * 215)];
	}

	public String getYamahaLabelDynaDecayRelease(final float value) {
		return this.labelDecayReleaseTable[(int) (value * 159)];
	}


	public String getYamahaLabelDynaThreshold(final float value) {
		return this.labelThresholdTable[(int) (value * 540)];
	}

	/** PUBLIC METHODS THAT RETURN COMPUTED LABELS **/

	public String getYamahaLabelPanning(final float value) {
	...
	public String getYamahaLabelPeqG(final float value) {
		final DecimalFormat df = new DecimalFormat("0.0");
		return df.format(value * 18) + "dB";
	}

	public String getYamahaLabelDynaAttack(final float value) {
		final int intValue = (int) (value * 120);
		return intValue + "ms";
	}

	public String getYamahaLabelDynaGain(final float value) {
		final float intValue = value * 18;
		final DecimalFormat df = new DecimalFormat("0.0");
		return df.format(intValue) + "dB";
	}

	public String getYamahaLabelDynaKnee(final float value) {
	...
	private void setYamahaDynamicHold88kHzGenericMidsize() {
		this.labelHoldData = "0.01ms 0.03ms 0.04ms 0.05ms 0.06ms 0.07ms 0.08ms 0.09ms 0.10ms 0.12ms 0.13ms " +
				"38.6ms 40.0ms 41.3ms 42.6ms 45.3ms 48.0ms 50.6ms 53.3ms 56.0ms 58.6ms 61.3ms 64.0ms 66.6ms " +
				"69.3ms 72.0ms 74.6ms 77.3ms 80.0ms 82.6ms 85.3ms 90.6ms 96.0ms 101ms 106ms 112ms 117ms 122ms " +
				"128ms 133ms 138ms 144ms 149ms 154ms 160ms 165ms 170ms 181ms 192ms 202ms 213ms 224ms 234ms " +
				"245ms 256ms 266ms 277ms 288ms 298ms 309ms 320ms 330ms 341ms 362ms 384ms 405ms 426ms 448ms " +
				"469ms 490ms 512ms 533ms 554ms 576ms 597ms 618ms 640ms 661ms 682ms 725ms 768ms 810ms 853ms " +
				"896ms 938ms 981ms";
	}
	...
	private void setYamahaDynamicDecayRelease88kHzGenericMidsize() {
		this.labelDecayReleaseData = "3ms 6ms 9ms 12ms 15ms 18ms 21ms 23ms 26ms 29ms 32ms 35ms 38ms 41ms 44ms 47ms " +
				"50ms 52ms 55ms 58ms 61ms 64ms 67ms 70ms 73ms 76ms 79ms 82ms 84ms 87ms 90ms 93ms 96ms 102ms " +
				"108ms 113ms 119ms 125ms 131ms 137ms 142ms 148ms 154ms 160ms 166ms 171ms 177ms 183ms 189ms 200ms " +
				"212ms 224ms 235ms 247ms 259ms 270ms 282ms 293ms 305ms 317ms 328ms 340ms 351ms 363ms 375ms 398ms " +
				"421ms 444ms 467ms 491ms 514ms 537ms 560ms 584ms 607ms 630ms 653ms 676ms 700ms 723ms 746ms 792ms " +
				"839ms 885ms 932ms 978ms 1.02s 1.07s 1.11s 1.16s 1.21s 1.25s 1.30s 1.35s 1.39s 1.44s 1.48s 1.58s " +
				"1.67s 1.76s 1.86s 1.95s 2.04s 2.13s 2.23s 2.32s 2.41s 2.51s 2.60s 2.69s 2.78s 2.88s 2.97s 3.16s " +
				"3.34s 3.53s 3.71s 3.90s 4.08s 4.27s 4.46s 4.64s 4.83s 5.01s 5.20s 5.38s 5.57s 5.76s 5.94s 6.31s " +
				"6.68s 7.06s 7.43s 7.80s 8.17s 8.54s 8.91s 9.28s 9.66s 10.0s 10.4s 10.7s 11.1s 11.5s 11.8s 12.6s " +
				"13.3s 14.1s 14.8s 15.6s 16.3s 17.0s 17.8s 18.5s 19.3s 20.0s 20.8s 21.5s 22.2s 23.0s";
	}

	private void setYamahaDynamicDecayRelease96kHzGenericMidsize() {
		this.labelDecayReleaseData = "3ms 6ms 8ms 11ms 14ms 16ms 19ms 22ms 24ms 27ms 30ms 32m s 35m s 38m s 40m s 43m s " +
				...
				"813ms 856ms 899ms 941ms 984ms 1.02s 1.06s 1.11s 1.15s 1.19s 1.24s 1.28s 1.32s 1.36s 1.45s 1.53s " +
				"1.62s 1.70s 1.79s 1.88s 1.96s 2.05s 2.13s 2.22s 2.30s 2.39s 2.47s 2.56s 2.64s 2.73s 2.90s 3.07s " +
				"3.24s 3.41s 3.58s 3.75s 3.92s 4.09s 4.26s 4.43s 4.61s 4.78s 4.95s 5.12s 5.29s 5.46s 5.80s 6.14s " +
				"6.48s 6.82s 7.16s 7.51s 7.85s 8.19s 8.53s 8.87s 9.21s 9.55s 9.89s 10.2s 10.5s 10.9s 11.6s 12.2s " +
				"12.9s 13.6s 14.3s 15.0s 15.7s 16.3s 17.0s 17.7s 18.4s 19.1s 19.7s 20.4s 21.1s";
	}
