...
public class InternalMessageHandler extends HandlerForGenericMidsize implements IMessageHandler {
	public InternalMessageHandler(final GenericMidsizeMixer mixer) {
		super(mixer);
	}
