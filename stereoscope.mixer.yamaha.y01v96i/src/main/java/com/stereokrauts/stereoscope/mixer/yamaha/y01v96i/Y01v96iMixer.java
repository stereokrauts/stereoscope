 ...
 *
 */
public final class Y01v96iMixer extends GenericMidsizeMixer {
	private final Y01v96iMidiTransmitter sysex;
	...
	private final Y01v96iPlugin pluginInstance;

	private AbstractApplicationContext context;

	public Y01v96iPlugin getPluginInstance() {
		return this.pluginInstance;
	}

	public Y01v96iMixer(final Y01v96iPlugin pluginInstance, final ISendMidi midi) {
		super(midi);
		if (pluginInstance != null) {
			this.context = pluginInstance.getApplContext();
		}
		this.pluginInstance = pluginInstance;
		this.sysex = new Y01v96iMidiTransmitter(this, midi);
	}
