...
/**
 * This class represents a Yamaha 01v96i mixer plugin.
 * @author th
 *
 */
public final class Y01v96iPlugin implements IMixerPlugin {
	...
	private final Y01v96iMixer mixer;
	private final IMidiInput input;
	private final IMidiOutput output;

	private static final SLogger LOG = StereoscopeLogManager.getLogger(Y01v96iPlugin.class);
	private static final String ID = "stereoscope.mixer.yamaha.y01v96i";

	public Y01v96iPlugin(final AbstractApplicationContext ctx, final IMidiInputPort inputPort, final IMidiOutputPort outputPort) throws MidiException {
		...
		this.mixer = new Y01v96iMixer(this, new ISendMidi() {
			@Override
			public void sendSysexData(final byte[] sysexdata) {
				try {
					Y01v96iPlugin.this.output.sendSysexMessage(sysexdata);
		...
		final Y01v96iMidiReceiver receiver = new Y01v96iMidiReceiver(this.mixer);
	...
	public IPersistentPluginConfiguration getPersistableConfiguration() {
		return new IPersistentPluginConfiguration() {
			...
			public MixerConnectionBean getConnectionBean() {
				...
				midiConnection.setInputPortName(Y01v96iPlugin.this.input.getName());
				midiConnection.setOutputPortName(Y01v96iPlugin.this.output.getName());
