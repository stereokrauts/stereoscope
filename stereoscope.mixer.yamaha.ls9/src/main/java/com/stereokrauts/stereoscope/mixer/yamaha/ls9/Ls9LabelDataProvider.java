 ...
 *
 */
public class Ls9LabelDataProvider {
	
	private static final SLogger LOGGER = StereoscopeLogManager.getLogger("yamaha-ls9-labelmaker");
	...
	public Ls9LabelDataProvider(final int samplerate) {
