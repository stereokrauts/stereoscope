/**
 * A fader view mainly for volume changes.
 * Includes a value label inside the faderknob.
 */
define([
  'jquery',
  'underscore',
  ...
  'easel'
	...
	var FaderVolumeView = ControlView.extend({
		...
		initialize: function(options) {
			...
			var self = this;
			_.bindAll(this, 'handleMouseMove', 'handleTweenIn', 'handleTweenOut', 'updateFaderKnob');
