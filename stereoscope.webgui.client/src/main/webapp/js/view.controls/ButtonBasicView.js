/**
 * A basic button view like in TouchOSC.
 */
define([
  'jquery',
  'underscore',
...
], function($, _, Backbone, easel, ControlView) {

	var ButtonBasicView = ControlView.extend({
		...
		setupButtonShapes: function() {
			this.buttonBackground = new easel.createjs.Shape();
			this.buttonEdge = new easel.createjs.Shape();
			this.hitArea = new easel.createjs.Shape();
		},
