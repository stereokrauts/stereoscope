...
define([
  ...
  'view.controls/ControlView'
	...
	var ButtonStdView = ControlView.extend({
		...
		initialize: function(options) {
			...
			_.bindAll(this, 'handleMouseDown', 'handleMouseUp');
			this.setupButton();
		...
		renderOnStatus: function() {
			if (this.model.get('oscValue')) {
				this.container.interactive.addChild(this.colorBg);
				this.stages.interactive.update();
		...
		renderOffStatus: function() {
			this.container.interactive.removeChild(this.colorBg);
