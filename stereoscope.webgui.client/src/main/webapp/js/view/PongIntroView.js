...
sk.stsc.view.PongIntroView = Backbone.View.extend({
	...
	drawRunnerBg: function(palette) {
		...
		var greyPalette = [
		                   '#000000',
		                   '#ffffff',
		                   commons.color.convertRgbToHex(this.c64grey1),
		                   commons.color.convertRgbToHex(this.c64grey1),
		                   commons.color.convertRgbToHex(this.c64grey2),
		                   commons.color.convertRgbToHex(this.c64grey1),
		                   commons.color.convertRgbToHex(this.c64grey2),
		                   commons.color.convertRgbToHex(this.c64grey2),
		                   commons.color.convertRgbToHex(this.c64grey3),
		                   commons.color.convertRgbToHex(this.c64grey2),
		                   commons.color.convertRgbToHex(this.c64grey3),
		                   commons.color.convertRgbToHex(this.c64grey3),
		                   'rgba(255, 255, 255, 1)',
		...
		var greenPalette = [
		                    '#000000',
		                    '#ffffff',
		                    commons.color.convertRgbToHex(this.c64brown),
		                    commons.color.convertRgbToHex(this.c64brown),
		                    commons.color.convertRgbToHex(this.c64green),
		                    commons.color.convertRgbToHex(this.c64brown),
		                    commons.color.convertRgbToHex(this.c64green),
		                    commons.color.convertRgbToHex(this.c64green),
		                    commons.color.convertRgbToHex(this.c64lightgreen),
		                    commons.color.convertRgbToHex(this.c64green),
		                    commons.color.convertRgbToHex(this.c64lightgreen),
		                    commons.color.convertRgbToHex(this.c64lightgreen),
		                    'rgba(255, 255, 255, 1)',
