/**
 * LayoutManager View
 * This is just a static container
 * that hosts the LayoutList.
 * It doesn't has a model since there is no data to handle.
 */
sk.stsc.view.LOManagerView = Backbone.View.extend({
	...
	setLayoutList: function() {
		this.layoutList = new sk.stsc.model.LOManagerListModel({
	...
	sendToServer: function(evt) {
		...
		var msg = {
			type: 'bin',
			oscStr: statics.osc.LAYOUT_TOSC_UPLOAD,
			file: {
