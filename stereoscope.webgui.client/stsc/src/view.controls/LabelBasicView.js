/**
 * The most basic version of a Label control
 * It holds simple text (with line wrapping)
 * and is not user editable. Therefore it has
 * no model. 
 */
sk.stsc.view.LabelBasicView = sk.stsc.view.ControlView.extend({
	...
	drawBackground: function() {
		...
		if (this.model.get('bgColor')) {
			...
			var rgb = statics.convertHexToRgb(this.model.get('bgColor'));
