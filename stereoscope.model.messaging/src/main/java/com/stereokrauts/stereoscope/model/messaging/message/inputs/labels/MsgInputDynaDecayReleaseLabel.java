 ...
 */
public class MsgInputDynaDecayReleaseLabel extends AbstractLabelMessage<String> {
	public MsgInputDynaDecayReleaseLabel(final int identifier, final int channel, final String label) {
