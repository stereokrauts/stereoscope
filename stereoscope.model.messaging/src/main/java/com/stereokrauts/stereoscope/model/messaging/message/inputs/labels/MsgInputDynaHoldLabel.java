 ...
 */
public class MsgInputDynaHoldLabel extends AbstractLabelMessage<String> {
	public MsgInputDynaHoldLabel(final int identifier, final int channel, final String label) {
