 ...
 * 
 */
public class OverridingPriorityQueueOverloadedException extends Exception {
	...
	public OverridingPriorityQueueOverloadedException(final MessageWithSender myMessage) {
