 ...
 */
public class MsgInputDynaRatioLabel extends AbstractLabelMessage<String> {
	public MsgInputDynaRatioLabel(final int identifier, final int channel, final String label) {
