 ...
 */
public class MsgInputDynaThresholdLabel extends AbstractLabelMessage<String> {
	public MsgInputDynaThresholdLabel(final int identifier, final int channel, final String label) {
