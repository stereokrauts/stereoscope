 ...
 */
public class MsgInputDynaGainLabel extends AbstractLabelMessage<String> {
	public MsgInputDynaGainLabel(final int identifier, final int channel, final String label) {
