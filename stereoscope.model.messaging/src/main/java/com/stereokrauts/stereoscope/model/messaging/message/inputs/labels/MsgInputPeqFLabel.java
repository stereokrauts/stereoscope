 ...
 */
public class MsgInputPeqFLabel extends AbstractLabelMessage<String> {
	public MsgInputPeqFLabel(final int channel, final int identifier, final String value) {
		super(identifier, channel, value);
	}
}
