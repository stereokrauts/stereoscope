 ...
 */
public class MsgInputDynaRangeLabel extends AbstractLabelMessage<String> {
	public MsgInputDynaRangeLabel(final int identifier, final int channel, final String label) {
