 ...
 */
public class MsgInputDynaAttackLabel extends AbstractLabelMessage<String> {
	public MsgInputDynaAttackLabel(final int identifier, final int channel, final String label) {
