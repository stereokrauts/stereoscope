 ...
 */
public class MsgChannelAuxLevelLabel extends AbstractLabelMessage<String> {
	public MsgChannelAuxLevelLabel(final int channel, final int identifier, final String label) {
