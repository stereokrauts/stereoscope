...
public class YamahaM7clDataConversionTest {
	TestData currentData = new TestData();
	private DummyMidiSink sink;
	private M7clMixer mixer;

	@Before
	public void initData()
	{
		this.sink = new DummyMidiSink();
		this.mixer = new M7clMixer(null, this.sink);
	}
	...
	public void testMixerToStereoscope()
	{
		...
		final M7clMidiReceiver recv = new M7clMidiReceiver(this.mixer);
